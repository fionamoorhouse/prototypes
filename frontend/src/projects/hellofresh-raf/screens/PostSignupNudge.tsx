  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden', minHeight: 0 }}>
        ...
        {/* Demo links */}
        <div style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: 8, alignItems: 'center' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', gap: 12 }}>
              <button
                onClick={() => {
                  setShowNudge(false)
                  goTo('MessageComposer', { channel: 'imessage' })
                }}
                style={{
                  flex: 1,
                  height: 48,
              ...
              <button
                onClick={() => {
                  setShowNudge(false)
                  goTo('MessageComposer', { channel: 'whatsapp' })
                }}
                style={{
                  flex: 1,
                  height: 48,
